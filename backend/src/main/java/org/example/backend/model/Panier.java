...
public class Panier {
    ...
    public List<ArticlePanier> getArticlesPanier() { return articlesPanier; }
    public void setArticlesPanier(List<ArticlePanier> articlesPanier) { this.articlesPanier = articlesPanier; }
